-- Migration 001: Configuration initiale de la base de données Echo
-- Création des tables principales et index
...
COMMENT ON SCHEMA public IS 'Echo Music Player Database - Version 1.0';
