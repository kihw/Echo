...
export function useLayoutClasses() {
  ...
  return {
    // Container principal
    container: `min-h-screen transition-colors duration-300 ease-in-out ${
      resolvedTheme === 'dark' 
        ? 'bg-slate-900 text-slate-100' 
        : 'bg-white text-slate-900'
    }`,
    ...
    // Sidebar
    sidebar: `h-full transition-colors duration-300 ease-in-out ${
      resolvedTheme === 'dark'
    ...
    // Header/Topbar
    header: `transition-colors duration-300 ease-in-out border-b ${
      resolvedTheme === 'dark'
        ? 'bg-slate-800 border-slate-700'
    ...
    // Main content
    main: `flex-1 transition-colors duration-300 ease-in-out ${
      resolvedTheme === 'dark'
        ? 'bg-slate-900'
        : 'bg-white'
    }`,
    ...
    // Cards
    card: `transition-colors duration-300 ease-in-out rounded-lg border ${
      resolvedTheme === 'dark'
        ? 'bg-slate-800 border-slate-700'
        : 'bg-white border-slate-200'
    }`,
    ...
    // Player bar
    player: `transition-colors duration-300 ease-in-out border-t ${
      resolvedTheme === 'dark'
        ? 'bg-slate-800 border-slate-700'
        : 'bg-white border-slate-200'
    }`,
    ...
    // Buttons
    buttonPrimary: `transition-all duration-200 ease-in-out rounded-lg px-4 py-2 font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 ${
      resolvedTheme === 'dark'
    ...
    buttonSecondary: `transition-all duration-200 ease-in-out rounded-lg px-4 py-2 font-medium border focus:outline-none focus:ring-2 focus:ring-offset-2 ${
      resolvedTheme === 'dark'
    ...
    // Input fields
    input: `transition-all duration-200 ease-in-out w-full px-3 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-offset-2 ${
      resolvedTheme === 'dark'
